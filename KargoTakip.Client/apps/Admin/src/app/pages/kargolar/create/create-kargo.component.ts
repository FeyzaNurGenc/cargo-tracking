...
@Component({
  imports: [FormsModule, BlankComponent, FlexiStepperModule, FormValidateDirective, NgxMaskDirective, FlexiSelectModule],
...
//readonly data= signal<KargoModel>(new KargoModel());
//readonly loading= signal<boolean>(false);
readonly pageTitle= computed(() => this.id() ? "Kargo Güncelle" : "Kargo Ekle");
//bu resource güncelleme işlemi için get yapıldığında verileri ekrana almak için yazıldı
